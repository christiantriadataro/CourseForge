...
import { u as usePlacementAliases } from "../../../composables/usePlacementAliases.mjs";
const useDropdown = (anchorComputed, floating, target, options) => {
  ...
  const { floatingStyles } = typeof document === "undefined" ? { floatingStyles: {} } : useFloating(anchorComputed, floating, {
