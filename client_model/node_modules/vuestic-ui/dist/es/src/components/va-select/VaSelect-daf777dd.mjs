import { _ as _sfc_main } from "./VaSelect.vue_vue_type_script_lang-ae99b441.mjs";
...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return openBlock(), createBlock(_component_va_dropdown, mergeProps({
    ...
    anchor: withCtx(() => [
      ...
      ]), 1040, ["class", "model-value", "onFocus", "onBlur", "onClick", "onKeydown"])
    ]),
    default: withCtx(() => [
...
//# sourceMappingURL=VaSelect-daf777dd.mjs.map
