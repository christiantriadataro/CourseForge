import { _ as _sfc_main } from "./VaDateInput.vue_vue_type_script_lang-32c38fc5.mjs";
...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return openBlock(), createBlock(_component_va_dropdown, mergeProps({
    ...
    "onUpdate:modelValue": _cache[10] || (_cache[10] = ($event) => _ctx.isOpenSync = $event),
    class: ["va-date-input", _ctx.$attrs.class],
    style: _ctx.$attrs.style
  }, _ctx.dropdownPropsComputed, { onOpen: _ctx.focusDatePicker }), {
    anchor: withCtx(() => [
    ...
    default: withCtx(() => [
      createVNode(_component_va_dropdown_content, {
        ...
        onKeydown: _cache[9] || (_cache[9] = withKeys(($event) => _ctx.focus(), ["esc"]))
      }, {
        default: withCtx(() => [
          createVNode(_component_va_date_picker, mergeProps({ ref: "datePicker" }, _ctx.datePickerProps, {
            ...
            "onUpdate:view": _cache[8] || (_cache[8] = ($event) => {
...
//# sourceMappingURL=VaDateInput-6d706981.mjs.map
