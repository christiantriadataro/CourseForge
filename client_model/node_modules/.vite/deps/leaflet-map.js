...
// node_modules/leaflet-map/node_modules/leaflet/dist/leaflet-src.js
var require_leaflet_src = __commonJS({
  "node_modules/leaflet-map/node_modules/leaflet/dist/leaflet-src.js"(exports, module) {
    (function(window2, document2, undefined) {
      var oldL = window2.L, L = {};
      L.version = "0.7.7";
      ...
      L.Mixin.Events = {
        ...
        fireEvent: function(type, data) {
          ...
          var event = L.Util.extend({}, data, { type, target: this });
      ...
      (function() {
        var ie = "ActiveXObject" in window2, ielt9 = ie && !document2.addEventListener, ua = navigator.userAgent.toLowerCase(), webkit = ua.indexOf("webkit") !== -1, chrome = ua.indexOf("chrome") !== -1, phantomjs = ua.indexOf("phantom") !== -1, android = ua.indexOf("android") !== -1, android23 = ua.search("android [23]") !== -1, gecko = ua.indexOf("gecko") !== -1, mobile = typeof orientation !== undefined + "", msPointer = !window2.PointerEvent && window2.MSPointerEvent, pointer = window2.PointerEvent && window2.navigator.pointerEnabled || msPointer, retina = "devicePixelRatio" in window2 && window2.devicePixelRatio > 1 || "matchMedia" in window2 && window2.matchMedia("(min-resolution:144dpi)") && window2.matchMedia("(min-resolution:144dpi)").matches, doc = document2.documentElement, ie3d = ie && "transition" in doc.style, webkit3d = "WebKitCSSMatrix" in window2 && "m11" in new window2.WebKitCSSMatrix() && !android23, gecko3d = "MozPerspective" in doc.style, opera3d = "OTransition" in doc.style, any3d = !window2.L_DISABLE_3D && (ie3d || webkit3d || gecko3d || opera3d) && !phantomjs;
      ...
      L.DomUtil = {
        ...
        documentIsLtr: function() {
          if (!L.DomUtil._docIsLtrCached) {
            ...
            L.DomUtil._docIsLtr = L.DomUtil.getStyle(document2.body, "direction") === "ltr";
          }
      ...
      (function() {
        if ("onselectstart" in document2) {
          L.extend(L.DomUtil, {
            disableTextSelection: function() {
              L.DomEvent.on(window2, "selectstart", L.DomEvent.preventDefault);
            },
            enableTextSelection: function() {
              L.DomEvent.off(window2, "selectstart", L.DomEvent.preventDefault);
            }
          });
        } else {
        ...
        L.extend(L.DomUtil, {
          disableImageDrag: function() {
            L.DomEvent.on(window2, "dragstart", L.DomEvent.preventDefault);
          },
          enableImageDrag: function() {
            L.DomEvent.off(window2, "dragstart", L.DomEvent.preventDefault);
          }
        });
      })();
      ...
      L.extend(L.LatLng, {
        ...
        MAX_MARGIN: 1e-9
        // max margin of error for the "equals" check
      });
      L.LatLng.prototype = {
        equals: function(obj) {
          if (!obj) {
      ...
      L.Map = L.Class.extend({
        ...
        fitBounds: function(bounds, options) {
          ...
          var paddingTL = L.point(options.paddingTopLeft || options.padding || [0, 0]), paddingBR = L.point(options.paddingBottomRight || options.padding || [0, 0]), zoom = this.getBoundsZoom(bounds, false, paddingTL.add(paddingBR));
        ...
        _initEvents: function(onOff) {
          ...
          if (this.options.trackResize) {
            L.DomEvent[onOff](window2, "resize", this._onResize, this);
          }
        },
        _onResize: function() {
      ...
      L.CRS.EPSG3395 = L.extend({}, L.CRS, {
        ...
        transformation: function() {
          var m = L.Projection.Mercator, r = m.R_MAJOR, scale = 0.5 / (Math.PI * r);
      ...
      L.Path = L.Class.extend({
        ...
        statics: {
          ...
          CLIP_PADDING: function() {
            var max = L.Browser.mobile ? 1280 : 2e3, target = (max / Math.max(window2.outerWidth, window2.outerHeight) - 1) / 2;
      ...
      L.Browser.svg = !!(document2.createElementNS && document2.createElementNS(L.Path.SVG_NS, "svg").createSVGRect);
      L.Path = L.Path.extend({
        ...
        _createElement: function(name) {
          return document2.createElementNS(L.Path.SVG_NS, name);
        },
      ...
      L.Path = L.Browser.svg || !L.Browser.vml ? L.Path : L.Path.extend({
        ...
        _createElement: function() {
          try {
            ...
            return function(name) {
              return document2.createElement(
      ...
      L.Path = L.Path.SVG && !window2.L_PREFER_CANVAS || !L.Browser.canvas ? L.Path : L.Path.extend({
        statics: {
      ...
      L.Map.include(L.Path.SVG && !window2.L_PREFER_CANVAS || !L.Browser.canvas ? {} : {
        _initPathRoot: function() {
      ...
      L.Draggable = L.Class.extend({
        ...
        _onDown: function(e) {
          ...
          L.DomEvent.on(document2, L.Draggable.MOVE[e.type], this._onMove, this).on(document2, L.Draggable.END[e.type], this._onUp, this);
        },
        _onMove: function(e) {
          ...
          if (!this._moved) {
            ...
            L.DomUtil.addClass(document2.body, "leaflet-dragging");
        ...
        _onUp: function() {
          L.DomUtil.removeClass(document2.body, "leaflet-dragging");
          if (this._lastTarget) {
            L.DomUtil.removeClass(this._lastTarget, "leaflet-drag-target");
            this._lastTarget = null;
          }
          for (var i in L.Draggable.MOVE) {
            L.DomEvent.off(document2, L.Draggable.MOVE[i], this._onMove).off(document2, L.Draggable.END[i], this._onUp);
          }
      ...
      L.Map.Drag = L.Handler.extend({
        ...
        _onDrag: function() {
          if (this._map.options.inertia) {
            var time = this._lastTime = +/* @__PURE__ */ new Date(), pos = this._lastPos = this._draggable._newPos;
        ...
        _onDragEnd: function(e) {
          var map = this._map, options = map.options, delay = +/* @__PURE__ */ new Date() - this._lastTime, noInertia = !options.inertia || delay > options.inertiaThreshold || !this._positions[0];
          map.fire("dragend", e);
          if (noInertia) {
            map.fire("moveend");
          } else {
      ...
      L.Map.ScrollWheelZoom = L.Handler.extend({
        ...
        _onWheelScroll: function(e) {
          ...
          var left = Math.max(40 - (+/* @__PURE__ */ new Date() - this._startTime), 0);
      ...
      L.extend(L.DomEvent, {
        ...
        addDoubleTapListener: function(obj, handler, id) {
          ...
          var endElement = L.Browser.pointer ? document2.documentElement : obj;
        ...
        removeDoubleTapListener: function(obj, id) {
          ...
          (L.Browser.pointer ? document2.documentElement : obj).removeEventListener(
            this._touchend,
            obj[pre + this._touchend + id],
            false
          );
          if (L.Browser.pointer) {
            document2.documentElement.removeEventListener(
      ...
      L.Map.TouchZoom = L.Handler.extend({
        ...
        _onTouchStart: function(e) {
          ...
          L.DomEvent.on(document2, "touchmove", this._onTouchMove, this).on(document2, "touchend", this._onTouchEnd, this);
          L.DomEvent.preventDefault(e);
        },
        ...
        _onTouchEnd: function() {
          ...
          L.Util.cancelAnimFrame(this._animRequest);
          L.DomEvent.off(document2, "touchmove", this._onTouchMove).off(document2, "touchend", this._onTouchEnd);
      ...
      L.Map.Tap = L.Handler.extend({
        ...
        _onDown: function(e) {
          ...
          L.DomEvent.on(document2, "touchmove", this._onMove, this).on(document2, "touchend", this._onUp, this);
        },
        _onUp: function(e) {
          clearTimeout(this._holdTimeout);
          L.DomEvent.off(document2, "touchmove", this._onMove, this).off(document2, "touchend", this._onUp, this);
      ...
      L.Map.BoxZoom = L.Handler.extend({
        ...
        _onMouseDown: function(e) {
          ...
          L.DomEvent.on(document2, "mousemove", this._onMouseMove, this).on(document2, "mouseup", this._onMouseUp, this).on(document2, "keydown", this._onKeyDown, this);
        },
        _onMouseMove: function(e) {
          if (!this._moved) {
          ...
          var startPoint = this._startLayerPoint, box = this._box, layerPoint = this._map.mouseEventToLayerPoint(e), offset = layerPoint.subtract(startPoint), newPos = new L.Point(
        ...
        _finish: function() {
          ...
          L.DomUtil.enableTextSelection();
          L.DomUtil.enableImageDrag();
          L.DomEvent.off(document2, "mousemove", this._onMouseMove).off(document2, "mouseup", this._onMouseUp).off(document2, "keydown", this._onKeyDown);
        },
      ...
      L.Map.Keyboard = L.Handler.extend({
        ...
        _addHooks: function() {
          L.DomEvent.on(document2, "keydown", this._onKeyDown, this);
        },
        _removeHooks: function() {
          L.DomEvent.off(document2, "keydown", this._onKeyDown, this);
        },
        _onKeyDown: function(e) {
      ...
      L.Map.include({
        ...
        _handleGeolocationResponse: function(pos) {
          var lat = pos.coords.latitude, lng = pos.coords.longitude, latlng = new L.LatLng(lat, lng), latAccuracy = 180 * pos.coords.accuracy / 40075017, lngAccuracy = latAccuracy / Math.cos(L.LatLng.DEG_TO_RAD * lat), bounds = L.latLngBounds(
...
var require_leaflet_map = __commonJS({
  "node_modules/leaflet-map/index.js"(exports, module) {
...
export default require_leaflet_map();
