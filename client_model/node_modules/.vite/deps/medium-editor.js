  ...
  "node_modules/medium-editor/dist/js/medium-editor.js"(exports, module) {
    ...
    (function(view) {
      ...
      var BlobBuilder = view.BlobBuilder || view.WebKitBlobBuilder || view.MozBlobBuilder || function(view2) {
        ...
        }, file_ex_codes = "NOT_FOUND_ERR SECURITY_ERR ABORT_ERR NOT_READABLE_ERR ENCODING_ERR NO_MODIFICATION_ALLOWED_ERR INVALID_STATE_ERR SYNTAX_ERR".split(" "), file_ex_code = file_ex_codes.length, real_URL = view2.URL || view2.webkitURL || view2, real_create_object_URL = real_URL.createObjectURL, real_revoke_object_URL = real_URL.revokeObjectURL, URL = real_URL, btoa = view2.btoa, atob = view2.atob, ArrayBuffer = view2.ArrayBuffer, Uint8Array2 = view2.Uint8Array, origin = /^[\w-]+:\/*\[?[\w\.:-]+\]?(?::[0-9]+)?/;
        FakeBlob.fake = FB_proto.fake = true;
        while (file_ex_code--) {
          FileException.prototype[file_ex_codes[file_ex_code]] = file_ex_code + 1;
        }
        if (!real_URL.createObjectURL) {
          URL = view2.URL = function(uri) {
    ...
    (function(root, factory) {
      ...
      (function() {
        ...
        function handleBlockDeleteKeydowns(event) {
          ...
          if (MediumEditor.util.isKey(event, [MediumEditor.util.keyCode.BACKSPACE, MediumEditor.util.keyCode.ENTER]) && // has a preceeding sibling
          ...
          } else if (MediumEditor.util.isKey(event, MediumEditor.util.keyCode.DELETE) && // between two sibling elements
          ...
          isHeader.test(node.nextElementSibling.nodeName.toLowerCase())) {
            ...
            event.preventDefault();
          } else if (MediumEditor.util.isKey(event, MediumEditor.util.keyCode.BACKSPACE) && tagName === "li" && // hitting backspace inside an empty li
...
export default require_medium_editor();
...
*/
//# sourceMappingURL=medium-editor.js.map
